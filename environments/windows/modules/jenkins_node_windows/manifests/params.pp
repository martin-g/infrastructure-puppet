...
class jenkins_node_windows::params (
  ...
  $chromedriver = ['2.29'],
  $geckodriver = ['0.16.1','0.18.0','0.23.0','0.27.0'],
  $gpg4win = ['3.1.5'],
  $gradle = ['3.5','4.3','4.3.1'],
  $graphviz = ['2.38'],
  $iedriver = ['2.53.1','3.4.0'],
  $jdk = ['jdk1.5.0_22-32','jdk1.5.0_22-64','jdk1.6.0_30','jdk1.7.0_79-unlimited-security','jdk1.8.0_152','jdk1.8.0_252+b09','jdk9.0','jdk9.0.1','jdk10_46','jdk11-ea+28','jdk12-ea+33','jdk13-ea+30','jdk14-ea+6','jdk15-ea+13','openjdk-ea+23'], # lint:ignore:140chars
