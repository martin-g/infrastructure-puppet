...
class jenkins_slave_windows::params (
  ...
  $jdk = ['jdk1.5.0_22-32','jdk1.5.0_22-64','jdk1.6.0_30','jdk1.7.0_79-unlimited-security','jdk1.8.0_152','jdk9.0','jdk9.0.1','jdk10_46','jdk11-ea+28','jdk12-ea+33','jdk13-ea+30','jdk14-ea+6','jdk15-ea+13'], # lint:ignore:140chars
